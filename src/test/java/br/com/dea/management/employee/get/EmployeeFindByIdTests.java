...
@Slf4j
public class EmployeeFindByIdTests {
    ...
    @BeforeEach
    void beforeEach() {
        log.info("Before each test in " + EmployeeFindByIdTests.class.getSimpleName());
    }

    @BeforeAll
    void beforeSuiteTest() {
        log.info("Before all tests in " + EmployeeFindByIdTests.class.getSimpleName());
    }
